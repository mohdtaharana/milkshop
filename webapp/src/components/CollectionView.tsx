    ...
    <div className="space-y-6">
      ...
      {showAddModal && (
        <ModalPortal onClose={() => setShowAddModal(false)}>
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 w-full max-w-lg sm:max-w-lg rounded-3xl shadow-2xl max-h-[90vh] flex flex-col overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <input 
                    ...
                    className="w-full h-10 px-3 border border-slate-200 dark:border-slate-700 rounded-xl text-xs bg-slate-50 dark:bg-slate-950 focus:ring-2 focus:ring-blue-500 focus:outline-hidden font-bold text-blue-600 dark:text-blue-400"
                  />
                </div>
                <div className="space-y-1">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input 
                      ...
                      className="w-full h-10 px-3 border border-slate-200 dark:border-slate-800 rounded-xl text-xs bg-white dark:bg-slate-900 focus:ring-2 focus:ring-blue-500 focus:outline-hidden font-bold font-mono text-blue-600 dark:text-blue-400"
                    />
                  </div>
                  <div className="space-y-1">
